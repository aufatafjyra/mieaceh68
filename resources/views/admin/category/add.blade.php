...
<div class="container">
    <div style="margin: 4%; margin-top: 2%; margin-bottom: 2%">
        <h5 style="text-align: center;"> Tambah Kategori </h5>
        <hr />
        ...
        <form action="{{ route('admin.category.store') }}" method="POST" style="padding-top: 10px;" enctype="multipart/form-data">
            ...
            <div class="menu-forms">
                <div class="form-group row">
                    <label for="name" style="width: 150px; font-size: 15px"> Nama Kategori </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="slug" style="width: 150px; font-size: 15px"> Slug Kategori </label>
                    <div class="col-md-10">
