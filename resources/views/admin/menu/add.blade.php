...
<div class="container">
    <div style="margin: 4%; margin-top: 2%; margin-bottom: 2%">
        <h5 style="text-align: center;"> Tambah Menu </h5>
        <hr />
            ...
            <div class="menu-forms" style="display: grid; grid-template-columns: 0.5fr 1fr;">
                ...
                <div class="forms">
                    <div class="form-group row">
                        <label for="name" style="width: 150px; font-size: 15px"> Nama Menu </label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row">
                        <label for="category" style="width: 160px; font-size: 15px"> Kategori </label>
                        <div class="col-md-5">
                    ...
                    <div class=" form-group row">
                        <label for="price" style="width: 150px; font-size: 15px"> Harga </label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        <label for="featured" style="width: 150px; font-size: 15px"> Menu Unggulan? </label>
                        <div class="col-md-10">
                            <input type="radio" name="featured" value="1" /> Ya
                            <input type="radio" name="featured" value="0" /> Tidak
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="desc" style="width: 150px; font-size: 15px"> Deskripsi Menu </label>
                        <div class="col-md-10">
