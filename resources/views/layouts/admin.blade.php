                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                <li><a href="/admin/home"><i class="fa fa-home" aria-hidden="true"></i> Beranda </a>
                                </li>
                            </ul>
                            @can('superadmin')
                            <ul class="nav side-menu">
                                <li><a href="/admin/website"><i class="fa fa-desktop" aria-hidden="true"></i> Pengelolaan Situs </a>
                                </li>
                            </ul>
                            @endcan
                            <ul class="nav side-menu">
                                <li><a href="{{ route('admin.users.index') }}"><i class="fa fa-user" aria-hidden="true"></i> Pengelolaan Pengguna </a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-cutlery"></i> Menu <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{ route('admin.menu.create') }}"> Tambah Menu </a></li>
                                    </ul>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-folder"></i> Kategori <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('admin.category.index') }}"> Kategori Menu </a></li>
                                        <li><a href="{{ route('admin.category.create') }}"> Tambah Kategori </a></li>
                                    </ul>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
