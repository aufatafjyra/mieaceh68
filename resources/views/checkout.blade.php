...
@section('title', 'Mie Aceh 68 - Checkout')
                    ...
                    <form class="form-inline">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="payment_method" id="payment_method" class="form-control" required>
                                <option value="" style="font-size: 15px;"> Pilih Pembayaran... </option>
                                <option name="payment_method" value="Bayar Sekarang" style="font-size: 15px;"> Bayar Sekarang </option>
                                <option name="payment_method" value="Bayar Nanti" style="font-size: 15px;"> Bayar Nanti </option>
                            </select>
                        </div>
