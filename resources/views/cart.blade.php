...
<div class="cart" style="min-height: 300px">
    ...
    <div class="cart-title">
        <h5> Ada {{ Cart::count() }} pesanan di keranjangmu! </h5>
    </div>
    ...
    <div class="cart-buttons">
        <a href="{{ route('menu.index') }}" class="btn btn-secondary" style="color: white;"> Lanjut Belanja </a>
        <a href="{{ route('checkout.index') }}" class="btn btn-danger" style="color: white; background-color: #BB4430"> Lanjut ke Pembayaran </a>
    </div>
